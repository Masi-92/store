        ...
        {categories.map((category, index) => (
          <div key={index} className="relative">
            <img
              ...
              alt={category.name}
            />
            <button className="absolute bottom-3 left-1/2 rounded-md	border-b min-w-20 -translate-x-1/2 px-1 transition ease-in-out delay-150 bg-blue-100 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
              {category.name}
            </button>
          </div>
        ))}
